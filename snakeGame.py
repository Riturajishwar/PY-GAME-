...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen("Welcome to Snakes", red, 260, 500)
        text_screen("Press Space Bar To Play", black, 232, 550)
